!(function (e, t) {
  ...
  var o,
    ...
    h =
      ((o = Error),
      r((s = u), (l = o)),
      (s.prototype = null === l ? Object.create(l) : ((p.prototype = l.prototype), new p())),
      u);
  function p() {
    this.constructor = s;
  }
  ...
  var f =
    ((y.prototype.create = function (e) {
      ...
      for (
        ...
        var f = u[p];
        '_' !== f.slice(-1) &&
          (f in c && console.warn('Overwriting FirebaseError base field "' + f + '" can cause unexpected behavior.'),
          (c[f] = i[f]));
      }
      return c;
    }),
    ...
    L =
      ...
      (S.prototype.getOrInitializeService = function (e) {
        ...
        return (
          !r &&
            this.component &&
            ((r = this.component.instanceFactory(this.container, (t = e) === N ? void 0 : t)), this.instances.set(e, r)),
          r || null
        );
      }),
  ...
  var T,
    x = { debug: C.DEBUG, verbose: C.VERBOSE, info: C.INFO, warn: C.WARN, error: C.ERROR, silent: C.SILENT },
    H = C.INFO,
    z =
      (((R = {})[C.DEBUG] = 'log'),
      (R[C.VERBOSE] = 'log'),
    ...
    B =
      ...
      V);
  function V(e) {
    (this.name = e), (this._logLevel = H), (this._logHandler = k), (this._userLogHandler = null), F.push(this);
  }
  function U(t) {
  ...
  var M,
    W =
      (((T = {})['no-app'] = "No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()"),
      ...
      (T['invalid-app-argument'] = 'firebase.{$appName}() takes either no argument or a Firebase App instance.'),
      (T['invalid-log-argument'] = 'First argument to `onLog` must be null or a function.'),
      T),
  ...
  function X(l) {
    var c = {},
      ...
      u = {
        ...
        onLog: function (e, t) {
          ...
          !(function (a, t) {
            for (var e = 0, r = F; e < r.length; e++) {
              !(function (e) {
                var o = null;
                t && t.level && (o = x[t.level]),
                  (e.userLogHandler =
                    null === a
                      ? null
                      : function (e, t) {
                          ...
                          t >= (null != o ? o : e.logLevel) &&
                            a({ level: C[t].toLowerCase(), message: i, args: r, type: e.name });
                        });
              })(r[e]);
            }
          })(e, t);
    ...
    function h(r) {
      var t,
        ...
        i = r.name;
      if (p.has(i))
        return J.debug('There were multiple attempts to register component ' + i + '.'), 'PUBLIC' === r.type ? u[i] : null;
      p.set(i, r),
        'PUBLIC' === r.type &&
          ((n = function (e) {
            if ((void 0 === e && (e = f()), 'function' != typeof e[i])) throw G.create('invalid-app-argument', { appName: i });
            return e[i]();
          }),
          void 0 !== r.serviceProps && v(n, r.serviceProps),
          (u[i] = n),
  ...
  var ee,
    ...
    re =
      ((ne.prototype.getPlatformInfoString = function () {
  ...
  'object' == typeof self &&
    ...
    (ee = self.firebase.SDK_VERSION) &&
      0 <= ee.indexOf('LITE') &&
      J.warn(
        '\n    Warning: You are trying to load Firebase while using Firebase Performance standalone script.\n    You should load Firebase Performance with this instance of Firebase to avoid loading duplicate code.\n    '
      ));
  var ie = te.initializeApp;
  te.initializeApp = function () {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return (
      (function () {
        try {
  ...
  (oe = se).INTERNAL.registerComponent(
    ...
    oe.registerVersion($, '0.6.10', ae),
    oe.registerVersion('fire-js', '');
  return se.registerVersion('firebase', '7.18.0', 'app'), se;
});
